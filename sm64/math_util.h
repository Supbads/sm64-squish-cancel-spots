#ifndef _SM64_MATH_UTIL_H
#define _SM64_MATH_UTIL_H

extern u32 gSineTableU32[];
extern s16 D_8038B000[];

#define gSineTable ((f32 *) &gSineTableU32[0])
#define gCosineTable ((f32 *) &gSineTableU32[1024])
